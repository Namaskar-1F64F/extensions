            ...
            if (textSource !== "manual") {
                ...
                if (explorer) {
                    ...
                    return ((0, jsx_runtime_1.jsx)(api_1.List.Item, { id: itemId, title: `Transaction: ${tx.hash.slice(0, 14)}...${tx.hash.slice(-8)}`, subtitle: chainExplorer?.chainName || `Chain ID ${tx.chainId}`, icon: chainExplorer?.iconUri || { source: api_1.Icon.Link }, accessories: [
                        ...
                        ], actions: (0, jsx_runtime_1.jsxs)(api_1.ActionPanel, { children: [chainExplorer ? ((0, jsx_runtime_1.jsx)(api_1.Action.OpenInBrowser, { url: `https://${chainExplorer.baseUrl}/tx/${tx.hash}`, title: "Open in Explorer", onOpen: () => handleItemAction(tx.hash) })) : ((0, jsx_runtime_1.jsx)(api_1.Action.OpenInBrowser, { url: `https://routescan.io/transaction/${tx.hash}?chainId=${tx.chainId}`, title: "Open in Routescan", onOpen: () => handleItemAction(tx.hash) })), (0, jsx_runtime_1.jsx)(api_1.Action.CopyToClipboard, { content: tx.hash, title: "Copy Hash", onCopy: () => handleItemAction(tx.hash) }), chainExplorer && selectedExplorer?.chainId !== parseInt(tx.chainId, 10) && ((0, jsx_runtime_1.jsx)(api_1.Action, { title: `Switch to ${chainExplorer.chainName}`, icon: api_1.Icon.Switch, onAction: () => {
                                        handleExplorerChange(chainExplorer);
                            ...
                            { text: token.symbol, icon: api_1.Icon.Tag },
                                    ...
                                    if (link.type &&
                                        ...
                                        (link.type === "url" ||
                                            ...
                                            link.type === "github" ||
                                            link.type === "coingecko")) {
                                        return ((0, jsx_runtime_1.jsx)(api_1.Action.OpenInBrowser, { url: link.value, title: `Open ${link.type.charAt(0).toUpperCase() + link.type.slice(1)}`, onOpen: () => handleItemAction(token.address) }, idx));
                                    }
                                    return null;
                                })] }) }, itemId));
                    ...
                    return ((0, jsx_runtime_1.jsx)(api_1.List.Item, { id: itemId, title: address.name || `Address: ${address.address.slice(0, 10)}...${address.address.slice(-8)}`, subtitle: chainExplorer?.chainName || `Chain ID ${address.chainId}`, icon: chainExplorer?.iconUri || { source: api_1.Icon.Person }, accessories: [
                        ...
                        ], actions: (0, jsx_runtime_1.jsxs)(api_1.ActionPanel, { children: [chainExplorer ? ((0, jsx_runtime_1.jsx)(api_1.Action.OpenInBrowser, { url: `https://${chainExplorer.baseUrl}/address/${address.address}`, title: "Open in Explorer", onOpen: () => handleItemAction(address.address) })) : ((0, jsx_runtime_1.jsx)(api_1.Action.OpenInBrowser, { url: `https://routescan.io/address/${address.address}?chainId=${address.chainId}`, title: "Open in Routescan", onOpen: () => handleItemAction(address.address) })), (0, jsx_runtime_1.jsx)(api_1.Action.CopyToClipboard, { content: address.address, title: "Copy Address", onCopy: () => handleItemAction(address.address) }), chainExplorer && selectedExplorer?.chainId !== parseInt(address.chainId, 10) && ((0, jsx_runtime_1.jsx)(api_1.Action, { title: `Switch to ${chainExplorer.chainName}`, icon: api_1.Icon.Switch, onAction: () => {
                                        handleExplorerChange(chainExplorer);
